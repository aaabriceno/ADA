/*
Supongamos que el coste de tender una red de fibra óptica entre dos ciudades es
...
std::vector<Conexion> construirRedOptica(const std::vector<Ciudad>& ciudades) {
    ...
    // Construir la red de fibra optica sin crear ciclos
...
int main() {
    ...
    std::cout << "Conexiones en la red de fibra optica:\n";
